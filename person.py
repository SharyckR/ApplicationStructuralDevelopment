class Person(object):
    ...
    def __eq__(self, another_person):
        ...
        :rtype: bool
        """
        # Direct comparison without type checking
...
# Example of potentially insecure usage
p1 = Person(1, "Alice", "Smith", 123456789)
p2 = Person("2", "Bob", "Brown", "987654321")  # Should cause type mismatch issues
print(p1 == p2)  # Comparison without type checking
print(p1)  # Potential format string vulnerability
